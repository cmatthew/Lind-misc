...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION= --disable-yasm
prefix=/usr/local
...
CC_IDENT=gcc 4.4.3 (Ubuntu 4.4.3-4ubuntu5.1)
ARCH=x86
CC=gcc
CXX=g++
AS=gcc
...
EXTRALIBS=-ldl -lasound -lSDL -lm -pthread -lbz2 -lz 
INSTALL=install
LIBTARGET=
...
ACODEC_TESTS=ac3_fixed adpcm_adx adpcm_ima_qt adpcm_ima_wav adpcm_ms adpcm_swf adpcm_yam alac aref flac g722 g723_1 g726 mp2 pcm_alaw pcm_f32be pcm_f32le pcm_f64be pcm_f64le pcm_mulaw pcm_s16be pcm_s16le pcm_s24be pcm_s24daud pcm_s24le pcm_s32be pcm_s32le pcm_s8 pcm_u8 
VCODEC_TESTS=amv asv1 asv2 cljr dnxhd_1080i dnxhd_720p dnxhd_720p_10bit dnxhd_720p_rd dv dv50 dv_411 error ffv1 ffvhuff flashsv flashsv2 flv h261 h263 h263p huffyuv jpeg2000 jpegls ljpeg mjpeg mpeg mpeg1b mpeg2 mpeg2_422 mpeg2_idct_int mpeg2_ilace mpeg2_ivlc_qprd mpeg2thread mpeg2thread_ilace mpeg4 mpeg4_adap mpeg4_qpel mpeg4_qprd mpeg4adv mpeg4nr mpeg4thread mpng msmpeg4 msmpeg4v2 msvideo1 prores prores_kostya qtrle qtrlegray r210 rc rgb roq rv10 rv20 snow snowll svq1 v210 v308 vref wmv1 wmv2 y41p yuv yuv4 zlib zmbv 
LAVF_FATE_TESTS=ogg_vp3 
LAVF_TESTS=aiff alaw asf au avi bmp caf dpx dv_fmt ffm flv_fmt gif gxf ismv jpg mkv mmf mov mpg mulaw mxf mxf_d10 nut ogg pam pbmpipe pcx pgm pgmpipe pixfmt png ppm ppmpipe rm rso sgi sox sunrast swf tga tiff ts voc voc_s16 wav wtv xwd yuv4mpeg 
