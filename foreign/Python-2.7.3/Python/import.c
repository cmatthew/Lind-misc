...
load_source_module(char *name, char *pathname, FILE *fp)
{
    ...
    if (cpathname != NULL &&
        ...
        DBP("trying to import %s precompiled from %s\n", name, cpathname);
	...
	co = read_compiled_module(cpathname, fpc);
        ...
        DBP("trying to import %s from %s\n", name, pathname);
        co = parse_source_module(pathname, fp);
        DBP("read in source module %s! \n", name);
	if (co == NULL)
            return NULL;
        if (Py_VerboseFlag)
